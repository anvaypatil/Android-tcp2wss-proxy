...
public class PortUnificationHandler extends FrameDecoder {
    ...
    private PortUnificationHandler(ClientSocketChannelFactory cf, IProxyTargetResolver resolver, WebsockifyServer.SSLSetting sslSetting, String keystore, String keystorePassword, String keystoreKeyPassword, String webDirectory, final ChannelHandlerContext ctx) {
    	this ( cf, resolver, sslSetting, keystore, keystorePassword, keystoreKeyPassword, webDirectory);
    	startDirectConnectionTimer(ctx);
    }
    
    public PortUnificationHandler(ClientSocketChannelFactory cf, IProxyTargetResolver resolver, WebsockifyServer.SSLSetting sslSetting, String keystore, String keystorePassword, String keystoreKeyPassword, String webDirectory) {
    	this.cf = cf;
    ...
    private void enableSsl(ChannelHandlerContext ctx) {
        ...
        p.addLast("unificationA", new PortUnificationHandler(cf, resolver, WebsockifyServer.SSLSetting.OFF, keystore, keystorePassword, keystoreKeyPassword, webDirectory, ctx));
        p.remove(this);
    }
